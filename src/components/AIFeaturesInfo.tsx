  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="mb-6"
      >
        <Card className="bg-gradient-to-r from-blue-50 to-purple-50 border-2 border-blue-200 p-4">
            ...
            <div className="flex-1">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="text-gray-700">
                      <span className="text-blue-600">Contextual Helper:</span>{" "}
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="text-gray-700">
                      <span className="text-purple-600">AI Coach:</span> Your
