...
const sourceIcon = path.join(__dirname, 'public', 'QualitySlop.png');
const publicDir = path.join(__dirname, 'public');

console.log('🎨 Generating PWA icons from QualitySlop.png...\n');

if (!fs.existsSync(sourceIcon)) {
  console.error('❌ Error: QualitySlop.png not found in public folder');
  process.exit(1);
}
